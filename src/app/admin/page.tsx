    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Link
          ...
          className="flex items-center gap-2 font-semibold px-4 py-2 rounded-lg transition-opacity text-sm"
              ...
              <div key={event.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg transition-shadow p-5 flex flex-col gap-3 relative overflow-hidden">
                ...
                <div className="flex gap-2 mt-auto pt-2 border-t border-gray-100">
                  <Link
                    ...
                    className="flex-1 text-center text-xs font-semibold py-1.5 rounded-lg transition-colors hover:bg-green-50"
                    style={{ color: '#206134' }}
                  >
                    Gestisci
                  </Link>
